...
/**
 * Used for MessagePack binary serialization format
 */
public class MessagePackTypeUtils {
    private static final ObjectMapper objectMapper = new ObjectMapper(new MessagePackFactory()).registerModule(new JavaTimeModule())
    ...
    public static <T> T fromByteArray(byte[] data, TypeReference<T> typeRef){
        try {
    ...
    public static <T> T fromByteArray(byte[] data, Type type){
